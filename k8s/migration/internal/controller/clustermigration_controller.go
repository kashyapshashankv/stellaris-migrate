...
// +kubebuilder:rbac:groups=vjailbreak.k8s.stellaris-migrate.io,resources=clustermigrations,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=vjailbreak.k8s.stellaris-migrate.io,resources=clustermigrations/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=vjailbreak.k8s.stellaris-migrate.io,resources=clustermigrations/finalizers,verbs=update
