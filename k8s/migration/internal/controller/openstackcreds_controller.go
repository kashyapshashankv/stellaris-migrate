...
// +kubebuilder:rbac:groups=migrate.k8s.stellaris.io,resources=openstackcreds,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=migrate.k8s.stellaris.io,resources=openstackcreds/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=migrate.k8s.stellaris.io,resources=openstackcreds/finalizers,verbs=update
// +kubebuilder:rbac:groups=migrate.k8s.stellaris.io,resources=pcdhosts,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=migrate.k8s.stellaris.io,resources=pcdhosts/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=migrate.k8s.stellaris.io,resources=pcdhosts/finalizers,verbs=update
// +kubebuilder:rbac:groups=migrate.k8s.stellaris.io,resources=pcdclusters,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=migrate.k8s.stellaris.io,resources=pcdclusters/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=migrate.k8s.stellaris.io,resources=pcdclusters/finalizers,verbs=update
