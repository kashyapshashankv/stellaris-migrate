...
// +kubebuilder:rbac:groups=vjailbreak.k8s.stellaris-migrate.io,resources=vjailbreaknodes,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=vjailbreak.k8s.stellaris-migrate.io,resources=vjailbreaknodes/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=vjailbreak.k8s.stellaris-migrate.io,resources=vjailbreaknodes/finalizers,verbs=update
