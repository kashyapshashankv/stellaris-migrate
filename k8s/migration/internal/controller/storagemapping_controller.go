...
// +kubebuilder:rbac:groups=vjailbreak.k8s.stellaris-migrate.io,resources=storagemappings,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=vjailbreak.k8s.stellaris-migrate.io,resources=storagemappings/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=vjailbreak.k8s.stellaris-migrate.io,resources=storagemappings/finalizers,verbs=update
