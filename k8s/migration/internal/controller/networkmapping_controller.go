...
// +kubebuilder:rbac:groups=vjailbreak.k8s.stellaris-migrate.io,resources=networkmappings,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=vjailbreak.k8s.stellaris-migrate.io,resources=networkmappings/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=vjailbreak.k8s.stellaris-migrate.io,resources=networkmappings/finalizers,verbs=update
