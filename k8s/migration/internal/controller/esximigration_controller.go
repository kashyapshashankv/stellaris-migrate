...
// +kubebuilder:rbac:groups=vjailbreak.k8s.stellaris-migrate.io,resources=esximigrations,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=vjailbreak.k8s.stellaris-migrate.io,resources=esximigrations/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=vjailbreak.k8s.stellaris-migrate.io,resources=esximigrations/finalizers,verbs=update
