...
// +kubebuilder:rbac:groups=migrate.k8s.stellaris.io,resources=esximigrations,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=migrate.k8s.stellaris.io,resources=esximigrations/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=migrate.k8s.stellaris.io,resources=esximigrations/finalizers,verbs=update
