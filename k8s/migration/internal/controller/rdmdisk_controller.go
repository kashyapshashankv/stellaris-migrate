...
// +kubebuilder:rbac:groups=migrate.k8s.stellaris.io,resources=rdmdisks,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=migrate.k8s.stellaris.io,resources=rdmdisks/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=migrate.k8s.stellaris.io,resources=rdmdisks/finalizers,verbs=update
