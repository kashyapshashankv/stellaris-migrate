...
func CleanupResources(ctx context.Context, kubeClient client.Client, restConfig *rest.Config) error {
	...
	gvrMigrationPlans := schema.GroupVersionResource{Group: "vjailbreak.k8s.stellaris-migrate.io", Version: "v1alpha1", Resource: "migrationplans"}
	...
	gvrRollingPlans := schema.GroupVersionResource{Group: "vjailbreak.k8s.stellaris-migrate.io", Version: "v1alpha1", Resource: "rollingmigrationplans"}
	...
	gvrNodes := schema.GroupVersionResource{Group: "vjailbreak.k8s.stellaris-migrate.io", Version: "v1alpha1", Resource: "vjailbreaknodes"}
